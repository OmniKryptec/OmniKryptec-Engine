...
public class CollisionSystem extends ComponentSystem {
    ...
    protected CollisionSystem() {
        super(Family.of(ComponentType.of(PositionComponent.class), ComponentType.of(HitBoxComp.class)));
        
    }
    
    private ComponentMapper<PositionComponent> posMapper = new ComponentMapper<>(PositionComponent.class);
    private ComponentMapper<HitBoxComp> hitMapper = new ComponentMapper<>(HitBoxComp.class);
    ...
    public void update(IECSManager manager, Time time) {
        ...
        for (int i = 0; i < entities.size(); i++) {
            ...
            for (int j = i + 1; j < entities.size(); j++) {
                ...
                HitBoxComp hit1 = hitMapper.get(e);
                HitBoxComp hit2 = hitMapper.get(entity);
