...
@Deprecated
public class OofRenderer2D implements OofRenderer, IRenderedObjectListener {
    ...
    public OofRenderer2D() {
        this(1000);
    }
    
    public OofRenderer2D(final int vertices) {
        this.batch = new SimpleBatch2D(vertices);
        initStuff();
    }
    
    public OofRenderer2D(final int vertices, final AbstractProjectedShaderSlot shaderslot) {
    ...
    public String toString() {
        return OofRenderer2D.class.getSimpleName() + "-" + this.countIndex;
    }
