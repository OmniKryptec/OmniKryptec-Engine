...
public class Shader {
    ...
    protected static final AdvancedFile SHADER_LOCATION = new AdvancedFile(true, "", "de", "omnikryptec", "shader",
	    "files");
    protected static final AdvancedFile SHADER_LOCATION_PP = new AdvancedFile(true, "", "de", "omnikryptec", "shader",
	    "files", "postprocessing");
    protected static final AdvancedFile SHADER_LOCATION_RENDER = new AdvancedFile(true, "", "de", "omnikryptec",
	    "shader", "files", "render");
    protected static final AdvancedFile DEF_SHADER_LOC_PP_VS = new AdvancedFile(true, SHADER_LOCATION_PP,
	    "pp_vert.glsl");
	...
	SHADERMODULES.addDynamic("MAX_LIGHTS",
		() -> Instance.getGameSettings().getInteger(GameSettings.MAX_FORWARD_LIGHTS));
	SHADERMODULES.addDynamic("ANIM_MAX_JOINTS",
		() -> Instance.getGameSettings().getInteger(GameSettings.ANIMATION_MAX_JOINTS));
	SHADERMODULES.addDynamic("ANIM_MAX_WEIGHTS",
