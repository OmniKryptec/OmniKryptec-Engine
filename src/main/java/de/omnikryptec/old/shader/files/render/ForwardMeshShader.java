...
public class ForwardMeshShader extends Shader {
	...
	super(new AdvancedFile(true, SHADER_LOCATION_RENDER,
		pv ? "forward_pv_shader_vert.glsl" : "forward_shader_vert.glsl").createInputStream(),
	...
	this.pervertex = pv;
	maxlights = OmniKryptecEngine.instance().getDisplayManager().getSettings()
		.getInteger(GameSettings.MAX_FORWARD_LIGHTS);
