...
import de.omnikryptec.graphics.shader.base.uniform.UniformMatrixArray;
...
public class AnimatedModelShader extends Shader {
    ...
    private static final AdvancedFile VERTEX_SHADER = new AdvancedFile(true, "", "de", "omnikryptec", "animation",
	    "renderer", "animatedEntityVertex.glsl");
    private static final AdvancedFile FRAGMENT_SHADER = new AdvancedFile(true, "", "de", "omnikryptec", "animation",
	    "renderer", "animatedEntityFragment.glsl");
    ...
    protected UniformMatrixArray jointTransforms = new UniformMatrixArray("jointTransforms",
	    Instance.getGameSettings().getInteger(GameSettings.ANIMATION_MAX_JOINTS));
	...
	super(VERTEX_SHADER.createInputStream(), FRAGMENT_SHADER.createInputStream(), "in_position", "in_textureCoords",
		"in_normal", "in_tangents", "in_jointIndices", "in_weights");
	registerUniforms(transformationMatrix, viewMatrix, projectionMatrix, diffuseMap, lightDirection,
		jointTransforms);
	start();
