...
public class SkinLoader {
	...
	final String jointDataId = XMLUtil.getChildWithAttribute(inputNode, "input", "semantic", "JOINT")
		.getAttributeValue("source").substring(1);
	final Element jointsNode = XMLUtil
		.getChild(XMLUtil.getChildWithAttribute(skinningData, "source", "id", jointDataId), "Name_array");
	...
	final Element inputNode = XMLUtil.getChild(skinningData, "vertex_weights");
	final String weightsDataId = XMLUtil.getChildWithAttribute(inputNode, "input", "semantic", "WEIGHT")
		.getAttributeValue("source").substring(1);
	final Element weightsNode = XMLUtil
		.getChild(XMLUtil.getChildWithAttribute(skinningData, "source", "id", weightsDataId), "float_array");
