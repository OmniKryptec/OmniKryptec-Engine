...
public class VertexArrayObject {
	...
	OpenGL.gl20vertexAttribPointer(attribute, attributeSize, GL11.GL_FLOAT, false, attributeSize * BYTES_PER_FLOAT,
		0);
	return this;
    }
	...
	for (int i = 0; i < data.length; i++) {
		...
		OpenGL.gl20vertexAttribPointer(i, lengths[i], data[i].getType(), false, lengths[i] * BYTES_PER_FLOAT,
			0);
	    }
	}
	return this;
	...
	for (int i = 0; i < lengths.length; i++) {
	    OpenGL.gl20vertexAttribPointer(i, lengths[i], GL11.GL_FLOAT, false, bytesPerVertex,
