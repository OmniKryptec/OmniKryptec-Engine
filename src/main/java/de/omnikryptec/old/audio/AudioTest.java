...
public class AudioTest {
	...
	// AudioManager.loadSound("Tobu_-_Infectious_[NCS_Release]",
	// "/de/omnikryptec/audio/Tobu_-_Infectious_[NCS_Release].wav");
	final AudioSource source = new AudioSource();
	timer.start();
	// source.setLooping(true);
	// source.play("bounce");
	final AdvancedFile file = new AdvancedFile(true, "", "de", "omnikryptec", "audio",
		"Tobu_-_Infectious_[NCS_Release].wav");
	final StreamedSound streamedSound = StreamedSound.ofAdvancedFile("Tobu_-_Infectious_[NCS_Release]_streamed",
		source, file);
