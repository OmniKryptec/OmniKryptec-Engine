...
import de.omnikryptec.old.util.error.ErrorItem;
...
public class Profiler implements ErrorItem {
	...
	String[] mergedlines = Util.merge(createNames(), " |", relatives, "|", createPerc(maxtime), "|",
		createLines(times, maxchars, maxtime), "|");
