...
public class Console extends JFrame implements ActionListener, LanguageReloader, KeyListener, WindowListener {
	...
	final int result = JOptionPane.showOptionDialog(this, spinner,
		getLang("console_change_font_size_q", "Enter new font size"), JOptionPane.OK_CANCEL_OPTION,
	...
	return de.omnikryptec.old.test.Utils.getKeysByValue(logLevelCheckBoxes, logLevel)
		.toArray(new JCheckBoxMenuItem[1])[0];
    }
	...
	try {
	    ...
	    if (logEntry_temp == null || logEntry_temp.getLogEntry() == null
		    || !(logEntry_temp.getLogEntry() instanceof AdvancedFile)) {
		return null;
	    }
	...
	panel_inputLayout.setHorizontalGroup(panel_inputLayout
	...
	panel_inputLayout.setVerticalGroup(panel_inputLayout
		.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_inputLayout.createSequentialGroup()
			...
			.addGroup(panel_inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
				.addComponent(textField_input, javax.swing.GroupLayout.PREFERRED_SIZE,
