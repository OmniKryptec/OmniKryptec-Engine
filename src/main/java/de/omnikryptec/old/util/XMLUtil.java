...
public class XMLUtil {
	...
	return element.getChildren().stream().filter((child) -> child.getName().equals(childName))
		.collect(Collectors.toList());
    }

    public static final Element getChildWithAttribute(Element element, String childName, String attributeName,
