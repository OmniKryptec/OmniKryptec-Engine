...
public class KeySettings implements XMLable {
     ...
     */
    public static final KeySettings STANDARDKEYSETTINGS = new KeySettings(new Key[] {new Key("mouseButtonLeft", 0, false), new Key("mouseButtonRight", 1, false), new Key("mouseButtonMiddle", 2, false), new Key("moveForward", GLFW.GLFW_KEY_W, true), new Key("moveBackward", GLFW.GLFW_KEY_S, true), new Key("moveRight", GLFW.GLFW_KEY_D, true), new Key("moveLeft", GLFW.GLFW_KEY_A, true), new Key("moveUp", GLFW.GLFW_KEY_SPACE, true), new Key("moveDown", GLFW.GLFW_KEY_LEFT_SHIFT, true), new Key("turnYawRight", GLFW.GLFW_KEY_RIGHT, true), new Key("turnYawLeft", GLFW.GLFW_KEY_LEFT, true), new Key("turnPitchUp", GLFW.GLFW_KEY_UP, true), new Key("turnPitchDown", GLFW.GLFW_KEY_DOWN, true), new Key("turnRollRight", GLFW.GLFW_KEY_E, true), new Key("turnRollLeft", GLFW.GLFW_KEY_Q, true)});
