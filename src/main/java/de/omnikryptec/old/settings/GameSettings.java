...
public class GameSettings implements XMLable {
	...
	element.addContent(
		new Element("property").setAttribute("name", "multisamples").setAttribute("value", "" + multisamples));
	element.addContent(
		new Element("property").setAttribute("name", "anisotropic").setAttribute("value", "" + anisotropic));
	if (keySettings != null) {
	...
	// element.addContent(new Element("property").setAttribute("name",
	// "fbo_factory").setAttribute("value", "" + fbo_factory));
	element.addContent(
		new Element("property").setAttribute("name", "chunkOffsetX").setAttribute("value", "" + chunkOffsetX));
	element.addContent(
		new Element("property").setAttribute("name", "chunkOffsetY").setAttribute("value", "" + chunkOffsetY));
	element.addContent(
		new Element("property").setAttribute("name", "chunkOffsetZ").setAttribute("value", "" + chunkOffsetZ));
	element.addContent(
		new Element("property").setAttribute("name", "chunkWidth").setAttribute("value", "" + chunkWidth));
	element.addContent(
		new Element("property").setAttribute("name", "chunkHeight").setAttribute("value", "" + chunkHeight));
	element.addContent(
		new Element("property").setAttribute("name", "chunkDepth").setAttribute("value", "" + chunkDepth));
	element.addContent(new Element("property").setAttribute("name", "deferredlight").setAttribute("value",
		"" + deferredlight));
	element.addContent(
		new Element("property").setAttribute("name", "forwardlight").setAttribute("value", "" + forwardlight));
	element.addContent(
		new Element("property").setAttribute("name", "chunkDepth").setAttribute("value", "" + chunkDepth));
	element.addContent(new Element("property").setAttribute("name", "enable_chunks").setAttribute("value",
		"" + enable_chunks));
	element.addContent(new Element("property").setAttribute("name", "maxinstancespdc").setAttribute("value",
		"" + maxinstancespdc));
	element.addContent(new Element("property").setAttribute("name", "frustrumCulling").setAttribute("value",
		"" + frustrumCulling));
	element.addContent(new Element("property").setAttribute("name", "multithreadedParticles").setAttribute("value",
		"" + multithreadedParticles));
	element.addContent(new Element("property").setAttribute("name", "minmultithreadedparticles")
		.setAttribute("value", "" + minmultithreadedparticles));
	element.addContent(
		new Element("property").setAttribute("name", "partThrPSize").setAttribute("value", "" + partThrPSize));
	final Element element_settings_objects = new Element("settings_objects");
	element.addContent(element_settings_objects);
	settings_objects.forEach((key, value) -> element_settings_objects
		.addContent(new Element("property").setAttribute("name", key).setAttribute("value", "" + value)));
	final Element element_settings_floats = new Element("settings_floats");
	element.addContent(element_settings_floats);
	settings_floats.forEach((key, value) -> element_settings_floats
		.addContent(new Element("property").setAttribute("name", key).setAttribute("value", "" + value)));
	final Element element_settings_integers = new Element("settings_integers");
	element.addContent(element_settings_integers);
	settings_integers.forEach((key, value) -> element_settings_integers
		.addContent(new Element("property").setAttribute("name", key).setAttribute("value", "" + value)));
	final Element element_settings_longs = new Element("settings_longs");
	element.addContent(element_settings_longs);
	settings_longs.forEach((key, value) -> element_settings_longs
		.addContent(new Element("property").setAttribute("name", key).setAttribute("value", "" + value)));
	final Element element_settings_booleans = new Element("settings_booleans");
	element.addContent(element_settings_booleans);
	settings_booleans.forEach((key, value) -> element_settings_booleans
		.addContent(new Element("property").setAttribute("name", key).setAttribute("value", "" + value)));
	return element;
    }
