...
public class Light3D extends GameObject3D {
     ...
     * distance: value between 0 and 1, 0 is in the middle and 1 is the highest
     * distance. final
     * <code>coneattenuation = a + b * distance + c * distance * distance</code>
     * <br>
     * lower values mean less light. the final light attenuation then is
     * <code>attenuation * cone-attenuation</code>.
     * 
     * @param a
     * @param b
     * @param c
    ...
    /**
     * the color and intensity of the light. values greater than 1 are allowed and
     * used for the intensity of the light.
     * 
     * @param c
     * @return this Light
     */
    ...
    /**
     * the direction the light is facing. if this light is not a spot- or
     * directionallight, this is ignored.
     * 
     * @param x
     * @param y
     * @param z
    ...
    /**
     * how big the angel in degrees of the spotlight is. if the light is not a
     * spotlight, this is ignored.
     * 
     * @param d
     * @return this Light
     */
    ...
    /**
     * how big the angel in radians of the spotlight is. if the light is not a
     * spotlight, this is ignored.
     * 
     * @param d
     * @return this Light
    ...
    /**
     * sets this light to be a directional light (e.g. sun). the normalized position
     * of this light is the direction of the light.
     * 
     * @param b
     * @return this Light
     */
    ...
    /**
     * sets this light to be a point light. modifys {@link #getConeInfo()} and if
     * this light is a directional light.
     * 
     * @return this Light
     */
    ...
    /**
     * how much the light attenuates into the distance (only for point- and
     * spotlights). distance: value between 0 and infinity.<br>
    ...
    /**
     * the maximum range the light can shine or <code>NO_CUTOFF_RANGE</code> to not
     * cutoff the light. this does not affect the attenuation of this light.
     * 
     * @param r
     * @return this Light
     */
