...
public class AttractedParticle extends Particle {
    ...
    public AttractedParticle(ParticleAtlas tex, Vector3f pos, Vector3f vel, float mass, float lifeLength, float rot, float scale, AttractedPaticleSystem system, RenderType type, float[] startcolor, float[] endcolor) {
