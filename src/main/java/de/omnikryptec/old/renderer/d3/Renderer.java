...
public abstract class Renderer {
    ...
    protected abstract long render(AbstractScene3D s, KeyArrayHashMap<AdvancedModel, List<Entity>> entities,
	    Shader started, FrustrumFilter filter);

    private Shader tmps = null;
    private long tmplong;

    public final long render(AbstractScene3D s, KeyArrayHashMap<AdvancedModel, List<Entity>> entities,
