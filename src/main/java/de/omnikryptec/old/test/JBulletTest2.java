...
public class JBulletTest2 {
    ...
    public static final void main(String[] args) {
        try {
            ...
            final SimpleTexture backgroundTexture = SimpleTexture.newTextureb("/de/omnikryptec/old/gameobject/terrain/grassy2.png")
                    .create();
            final SimpleTexture rTexture = SimpleTexture.newTextureb("/de/omnikryptec/old/gameobject/terrain/mud.png").create();
            final SimpleTexture gTexture = SimpleTexture.newTextureb("/de/omnikryptec/old/gameobject/terrain/grassFlowers.png").create();
            final SimpleTexture bTexture = SimpleTexture.newTextureb("/de/omnikryptec/old/gameobject/terrain/path.png").create();
            final SimpleTexture blendMap = SimpleTexture.newTextureb("/de/omnikryptec/old/gameobject/terrain/blendMap.png").create();
            try {
                heightMap = ImageIO.read(Terrain.class.getResourceAsStream("/de/omnikryptec/old/gameobject/terrain/heightmap.png"));
            } catch (Exception ex) {
            ...
            final StreamedSound streamedSound = StreamedSound.ofInputStream("Tobu_-_Infectious_[NCS_Release]", source,
                    JBulletTest2.class.getResourceAsStream("/de/omnikryptec/old/audio/Tobu_-_Infectious_[NCS_Release].wav"));
