...
public class EngineTest {
	...
	try {
	    ...
	    Model brunnen = new Model("",
		    ObjLoader.loadOBJ(EngineTest.class.getResourceAsStream("/de/omnikryptec/test/brunnen.obj")));
	    // Model brunnen = Model.generateQuad();
	    SimpleTexture brunnent = SimpleTexture
		    .newTextureb(EngineTest.class.getResourceAsStream("/de/omnikryptec/test/brunnen.png")).create();
