...
public class XMLTest {
	...
	try {
		 ...
		 * Logger.log("worlds.size() == " + worlds.size()); for(World world : worlds) {
		...
		AdvancedFile file = AdvancedFile.fileOfPath("E:\\Daten\\NetBeans\\Projekte\\OmniKryptec-Engine\\temp")
			.addPaths("Test.xml");
		...
		HashMap<Class<?>, ArrayList<DataMapSerializable>> xmlsc = dataMapSerializer
			.deserializeToDataMapSerializable(file.createInputStream(), XMLSerializer.newInstance());
	    }
