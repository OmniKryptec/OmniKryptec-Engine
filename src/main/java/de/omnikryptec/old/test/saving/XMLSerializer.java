...
public class XMLSerializer implements IDataMapSerializer {
    ...
    private final void processObjectSerialize(Element element, Object name, Object object, int depth, Type lastType,
	    Type lastOperationType, Object... objects) {
	try {
    ...
    private final void processDataMapsSerialize(Element element, Object name, Type lastOperationType, DataMap dataMap,
	    int depth) {
    ...
    private final void processListSerialize(Element element, Object name, Type lastOperationType, List list,
	    int depth) {
    ...
    private final void processArraySerialize(Element element, Object name, Type lastOperationType, Object array,
	    int depth, Object... objects) {
	final Element element_temp = new Element(Type.Array.name()).setAttribute(DEPTH, "" + (depth - 1));
	if ((lastOperationType != null) && (lastOperationType == Type.DataMap || lastOperationType == Type.Map)) {
	    element_temp.setAttribute(KEY, "" + name);
	} else {
	    element_temp.setAttribute(NAME, "" + name);
