...
import de.omnikryptec.old.gameobject.particles.AttractedPaticleSystem;
import de.omnikryptec.old.gameobject.particles.ParticleAttractor;
import de.omnikryptec.old.gui.ProgressBar;
import de.omnikryptec.old.gui.TexturedGuiContainer;
import de.omnikryptec.old.main.OmniKryptecEngine;
import de.omnikryptec.old.main.Scene3D;
import de.omnikryptec.old.renderer.d3.FloorReflectionRenderer;
...
//            System.out.println(result);
	    // XMLUtil.save(OmniKryptecEngine.instance().getDisplayManager().getSettings().toXMLDocument(),
	    // Format.getPrettyFormat(), new AdvancedFile(false,
	    // "gamesettings.xml").createOutputstream(false));
...
//            SimpleTexture brunnen_specular = ResourceLoader.currentInstance().getTexture("omnikryptec:test:brunnen_specular.png")/*SimpleTexture.newTexture("/de/omnikryptec/test/brunnen_specular.png")*/;
	    SimpleTexture baum = ResourceLoader.currentInstance().getTexture(
		    "res:final_tree_3.png")/*
					    * SimpleTexture.newTexture(new AdvancedFile(true, res, "final_tree_3.png"))
					    */;
