...
public class DefaultResourceManager implements ResourceLoader, ResourceManager {
    ...
    public static DefaultResourceManager createDefaultInstance(final boolean asCurrent, final boolean searchForDefaultLoaders) {
    ...
    @Override
    public boolean load(final AdvancedFile advancedFile, final AdvancedFile superFile, final Properties properties, final ResourceManager resourceManager) throws Exception {
        return loadIntern(advancedFile, superFile, properties, resourceManager);
    }
    
    @Override
    public LoadingType accept(final AdvancedFile advancedFile, final AdvancedFile superFile, final Properties properties, final ResourceManager resourceManager) throws Exception {
    ...
    private boolean loadIntern(final AdvancedFile advancedFile, final AdvancedFile superFile, final Properties properties, final ResourceManager resourceManager) throws Exception {
    ...
    public DefaultResourceManager stageAdvancedFiles(final int priority, final long options, final AdvancedFile... advancedFiles) {
        checkAndErrorIfLoading(true);
    ...
    public List<ResourceLoader> getResourceLoadersForAdvancedFile(final AdvancedFile advancedFile, final AdvancedFile superFile, final Properties properties, final ResourceManager resourceManager) {
