...
public class InputManager {
    ...
    public boolean isMouseButtonPressed(int buttonCode) {
        ...
        return mouseHandler.isButtonPressed(buttonCode); // || mouseHandler.isButtonRepeated(buttonCode); //TODO Can a
                                                         // mouse buttons state be "REPEATED"?
    }
    ...
    private void updateMouseDeltas(Vector2d mousePosition, Vector2d mouseScrollOffset) {
        ...
        // TODO Maybe split this up, because this below was executed as the last part in
        // the old update ("nextFrame") method
