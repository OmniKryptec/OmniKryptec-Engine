...
public class AudioPlaylist {
    ...
    //TODO Vielleicht das Playlist extenden lassen, und dann ist PlayList eine lustige PlayList, die alle funktionen generisch eingebaut hat wie shuffle oder einfach abspielen mit naechster und so
    ...
    public final boolean removeSounds(ISound... sounds) { //TODO Falls der sound gerade gespielt wird, muss er gestoppt werden
        if (sounds != null && sounds.length > 0) {
