...
public class AnimationLoader {
    ...
    private float[] getKeyTimes() {
        final Element timeData = XMLUtil.getChild(XMLUtil.getChild(XMLUtil.getChild(animationData, "animation"), "source"), "float_array");
    ...
    private String getDataId(Element jointData) {
        final Element node = XMLUtil.getChildWithAttribute(XMLUtil.getChild(jointData, "sampler"), "input", "semantic", "OUTPUT");
    ...
    private String findRootJointName() {
        final Element skeleton = XMLUtil.getChildWithAttribute(XMLUtil.getChild(jointHierarchy, "visual_scene"), "node", "id", "Armature");
