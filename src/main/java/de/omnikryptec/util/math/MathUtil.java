...
public class MathUtil {
    ...
    public static Vector2f relativeMousePosition(Vector2dc displayMousePosition, int[] viewport, Vector2f target) {
        return relativeMousePosition(displayMousePosition.x(), displayMousePosition.y(), viewport, target);
    }
    
    public static Vector2f relativeMousePosition(double x, double y, final int[] viewport, Vector2f target) {
        if (target == null) {
            target = new Vector2f();
        }
