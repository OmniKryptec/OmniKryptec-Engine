...
public abstract class Pool<T> {
	...
	/**
	 * Get a free object. If none is available, a new one might be
	 * created via {@link #newObject()} or an exception might be thrown.
	 * 
	...
	/**
	 * Returns the amount of free objects in this {@link Pool}. If there are infinite free objects, a number equal to or greater than 1 must be returned.
