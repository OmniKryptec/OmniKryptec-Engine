...
public class DefaultTextureLoader implements Loader {
    ...
    public boolean load(AdvancedFile advancedFile, AdvancedFile superFile, Properties properties, ResourceLoader resourceLoader) {
        ...
        Logger.log(String.format("Loaded SimpleTexture \"%s\" from \"%s\" (in \"%s\")%s", name, advancedFile, superFile, properties == null ? "" : String.format(" (with properties %s)", properties))); //TODO Only for testing!!! DELETE THIS!
