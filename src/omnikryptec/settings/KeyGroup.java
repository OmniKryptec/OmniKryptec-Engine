...
public class KeyGroup implements IKey {
	 ...
	 * 
	 * @param allKeysNeedToBeActivated
	 *            Boolean If all Keys in this KeyGroup are needed to be
	 *            activated
