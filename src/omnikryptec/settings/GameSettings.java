...
public class GameSettings {
	 ...
	 * 
	 * @param clampEdges
	 *            Boolean If the edges should be clamped
	 * @return GameSettings A reference to this GameSettings
	 */
	 ...
	 * 
	 * @param mipmap
	 *            Boolean If mipmapping should be activated
	 * @return GameSettings A reference to this GameSettings
	 */
	 ...
	 * 
	 * @param nearest
	 *            Boolean if the nearest objects(?) should be filtered
	 * @return GameSettings A reference to this GameSettings
	 */
