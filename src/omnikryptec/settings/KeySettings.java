...
public class KeySettings {
     ...
     */
    public static final KeySettings STANDARDKEYSETTINGS = new KeySettings(
            new Key[]{new Key("mouseButtonLeft", 0, false), new Key("mouseButtonRight", 1, false),
    ...
    /**
     * Returns if a IKey given by the name is pressed and no other IKey with
     * these keys is pressed
     *
     * @param name String Name of the IKey
     * @return <tt>true</tt> if the IKey is pressed and the only one pressed
     * with its keys
     */
    ...
    /**
     * Returns if a IKey given by the name is pressed for a specified time and
     * no other IKey with these keys is pressed
     *
     * @param name String Name of the IKey
     * @param minTime Float Minimum pressing time
     * @param maxTime Float Maximum pressing time
     * @return <tt>true</tt> if the IKey is pressed for the specified time and
     * the only one pressed with its keys
     */
