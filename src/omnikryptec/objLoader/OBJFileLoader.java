/*
 * Made bei ThinMatrix (YouTube)
 */

package omnikryptec.objLoader;
...
public class OBJFileLoader {
	...
	public static ModelData loadOBJModOption(InputStream stream) {

		InputStreamReader objStream = null;
		try {
			objStream = new InputStreamReader(stream);
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(-1);
		}
