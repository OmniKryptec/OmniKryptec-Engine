...
import omnikryptec.terrain.TerrainGeneratorHeightMap;
    ...
    private static final void setupTerrains(TerrainTexturePack texturePack, Texture blendMap, int count) {
        for(int x = 0; x < count; x++) {
            for(int y = 0; y < count; y++) {
                final ModelData modelData = Terrain.generateTerrain(x * heightMap.getWidth(), y * heightMap.getWidth(), new TerrainGeneratorHeightMap(heightMap, 40.0F, true), heightMap.getWidth(), heightMap.getWidth());
