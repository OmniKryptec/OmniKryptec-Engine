package omnikryptec.test.backup;

import omnikryptec.logger.*;
...
public class Console extends JFrame implements ActionListener, KeyListener, WindowListener {
    ...
    private final HashMap<LogLevel, Boolean> logLevelVisibilities = new HashMap<LogLevel, Boolean>() {{
        for(LogLevel ll : LogLevel.values()) {
            put(ll, false);
        }
    }};
    private final HashMap<JCheckBoxMenuItem, LogLevel> logLevelCheckBoxes = new HashMap<JCheckBoxMenuItem, LogLevel>() {{
        for(LogLevel ll : LogLevel.values()) {
    ...
    private void initListeners() {
        ...
        M2C6.addActionListener(this);
        M2C7.addActionListener(this);
        M2C8.addActionListener(this);
        M2C9.addActionListener(this);
        M2C10.addActionListener(this);
    }
    ...
    private void init() {
        ...
        M2C5.setSelected(false);
        M2C6.setSelected(false);
        M2C7.setSelected(false);
        M2C8.setSelected(false);
        M2C9.setSelected(false);
        M2C10.setSelected(false);
        for(LogLevel ll : LogLevel.values()) {
    ...
    private void reloadCheckBoxSelectionsFromSave() {
        ...
        M2C6.setSelected(logLevelVisibilities.get(LogLevel.INFO));      //Normal
        M2C7.setSelected(logLevelVisibilities.get(LogLevel.ERROR));     //Error
        M2C8.setSelected(logLevelVisibilities.get(LogLevel.INPUT));     //Input
        M2C9.setSelected(logLevelVisibilities.get(LogLevel.COMMAND));   //Command
        M2C10.setSelected(logLevelVisibilities.get(LogLevel.FINE));     //Low
    }
    ...
    private void reloadCheckBoxSelectionsToSave() {
        ...
        logLevelVisibilities.put(LogLevel.INFO,     M2C6.isSelected());
        logLevelVisibilities.put(LogLevel.ERROR,    M2C7.isSelected());
        logLevelVisibilities.put(LogLevel.INPUT,    M2C8.isSelected());
        logLevelVisibilities.put(LogLevel.COMMAND,  M2C9.isSelected());
        logLevelVisibilities.put(LogLevel.FINE,     M2C10.isSelected());
    }
    
    public Console reloadConsole(boolean update) {
        final ArrayList<LogEntry> logEntries = getLogEntriesSorted(update);
        reloadConsole(logEntries, false);
        return this;
    }
    
    public ArrayList<LogEntry> getLogEntriesSorted(boolean update) {
        final ArrayList<LogEntry> logEntries = Logger.LOG;
    ...
    private void initComponents() {
        ...
        M2C10 = new javax.swing.JCheckBoxMenuItem();
        ...
        M2C6.setText("Show Normal");
        M2.add(M2C6);

        M2C7.setSelected(true);
        M2C7.setText("Show Error");
        M2.add(M2C7);

        M2C8.setSelected(true);
        M2C8.setText("Show Input");
        M2.add(M2C8);

        M2C9.setSelected(true);
        M2C9.setText("Show Command");
        M2.add(M2C9);

        M2C10.setSelected(true);
        M2C10.setText("Show Low");
        M2.add(M2C10);
        M2.add(M2S1);
    ...
    private javax.swing.JCheckBoxMenuItem M2C10;
    ...
    private javax.swing.JCheckBoxMenuItem M2C6;
    private javax.swing.JCheckBoxMenuItem M2C7;
    private javax.swing.JCheckBoxMenuItem M2C8;
    private javax.swing.JCheckBoxMenuItem M2C9;
