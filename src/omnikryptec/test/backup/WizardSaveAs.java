...
public class WizardSaveAs extends javax.swing.JDialog implements ActionListener, WindowListener {
    ...
    private LogEntry finish() {
        try {
            ...
            logEntry.setLogEntryFormat(LogEntryFormatter.toggleFormat(logEntry.getLogEntryFormat(), checkBox_save_infos_timestamp.isSelected(), checkBox_save_infos_appearance.isSelected(), checkBox_save_infos_thread.isSelected(), checkBox_save_infos_level.isSelected(), true, true));
        ...
        panel_settings_settingsLayout.setVerticalGroup(
            ...
            .addGroup(panel_settings_settingsLayout.createSequentialGroup()
                ...
                .addGroup(panel_settings_settingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(checkBox_save_level_normal))
                .addGap(18, 18, 18)
                .addComponent(jseparator_settings, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_settings_settingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(label_save_infos)
                    .addComponent(checkBox_save_infos_level)
