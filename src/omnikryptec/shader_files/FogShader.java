...
public class FogShader extends Shader {
	...
	public FogShader() {
		super(FogShader.class.getResourceAsStream(DEFAULT_PP_VERTEX_SHADER_LOC), FogShader.class.getResourceAsStream(oc_shader_loc+"fog_shader_frag.glsl"), Shader.DEFAULT_PP_VERTEX_SHADER_POS_ATTR, depth, texture, test, fog, density, gradient);
		start();
