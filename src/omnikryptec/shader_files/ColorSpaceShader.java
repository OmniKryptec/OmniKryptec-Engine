...
public class ColorSpaceShader extends Shader {
	...
	public ColorSpaceShader() {
		super(Shader.class.getResourceAsStream(Shader.DEFAULT_PP_VERTEX_SHADER_LOC), Shader.class.getResourceAsStream(Shader.oc_shader_loc+"color_space_shader_frag.glsl"), Shader.DEFAULT_PP_VERTEX_SHADER_POS_ATTR, value,sampler);
		start();
