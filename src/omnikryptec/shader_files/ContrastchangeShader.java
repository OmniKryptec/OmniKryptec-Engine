...
public class ContrastchangeShader extends Shader {
	...
	public ContrastchangeShader() {
		super(Shader.class.getResourceAsStream(DEFAULT_PP_VERTEX_SHADER_LOC), Shader.class.getResourceAsStream(oc_shader_loc+"contrastshanger_shader_frag.glsl"), DEFAULT_PP_VERTEX_SHADER_POS_ATTR,change,scene);
		start();
		scene.loadTexUnit(0);
	}
