    ...
    public static final File getAppDataFolder(String folderName) {
        ...
        switch(OS) {
            case WINDOWS:
                ...
                break;
            case MAC:
                file = new File(USER_HOME.getAbsolutePath() + File.separator + "Library" + File.separator + "Application Support" + File.separator + folderName); //TODO Needs confirmation!
                break;
            case UNIX:
            ...
            if(jarFile.isFile()) {
                ...
                if(url != null) {
                    ...
                    for(File app : apps.listFiles()) {
                        try {
                            Files.copy(app.toPath(), new File(folder.getAbsolutePath() + File.separator + app.getName()).toPath(), StandardCopyOption.COPY_ATTRIBUTES);
