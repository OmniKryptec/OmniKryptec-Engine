package omnikryptec.util.debug;
...
public abstract class SignalAwaiter<T> {
	 ...
	 * 
	 * @param signal
	 *            Signal on which is waited
	 * @param amount
	 *            Long Amount of maximum time to be waited for
	 * @param unit
	 *            TimeUnit Unit for the amount
	 */
	...
	/**
	 * Override this so the SignalAwaiter can retrieve the state of the
	 * monitored variable
	 * 
	 * @return Signal
	 */
