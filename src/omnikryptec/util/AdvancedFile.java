...
public class AdvancedFile {
	 ...
	 * 
	 * @param parent
	 *            Object If File than it can be the Folder, where the Paths is
	 *            in (If null then this AdvancedFile is a relative path) or if
	 *            it is an AndvancedFile than this AdvancedFile is a child of
	 *            the parent AdvancedFile
	 * @param paths
	 *            String Array Paths
	 */
	 ...
	 * 
	 * @param folder
	 *            File Folder (If null then this AdvancedFile is a relative
	 *            path)
	 * @return A reference to this AdvancedFile
	 */
	 ...
	 * 
	 * @param parents
	 *            Object Array If File than it can be the Folder, where the
	 *            Paths is in (If null then this AdvancedFile is a relative
	 *            path) or if it is an AndvancedFile than this AdvancedFile is a
	 *            child of the parent AdvancedFile
	 * @return A reference to this AdvancedFile
	 */
	 ...
	 * 
	 * @param append
	 *            Boolean If anything should be added to file or should it
	 *            overwrite it
