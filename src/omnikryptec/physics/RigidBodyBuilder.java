...
public class RigidBodyBuilder {
	...
	public RigidBodyBuilder(float mass, org.lwjgl.util.vector.Vector3f position,
			org.lwjgl.util.vector.Vector3f rotation, CollisionShape collisionShape) {
		this.mass = mass;
		setDefaultMotionState(position, rotation);
		this.collisionShape = collisionShape;
	}
	...
	public final RigidBodyBuilder setDefaultMotionState(org.lwjgl.util.vector.Vector3f position,
