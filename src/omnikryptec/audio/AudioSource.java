...
public class AudioSource {
	 ...
	 * 
	 * @param name
	 *            String Name of the Sound to be played
	 ...
	 * 
	 * @param loop
	 *            Boolean <tt>true</tt> if the ISound should be played in a loop
	 * @return AudioSource A reference to this AudioSource
	 */
	 ...
	 * 
	 * @param volume
	 *            Float Volume (0.0F = Nothing, 1.0F = Normal)
	 * @return AudioSource A reference to this AudioSource
	 */
	 ...
	 * 
	 * @param orientation
	 *            Vector3f Vector of the orientation
	 * @return AudioSource A reference to this AudioSource
	 */
	 ...
	 * 
	 * @param x
	 *            Float Float of the x-orientation
	 * @param y
	 *            Float Float of the y-orientation
	 * @param z
	 *            Float Float of the z-orientation
	 * @return AudioSource A reference to this AudioSource
	 */
	 ...
	 *            Float Reference distance (Reference distance is the point
	 *            where the Volume = 1.0F)
	 * @return AudioSource A reference to this AudioSource
	 */
	 ...
	 *            Boolean If this AudioSource is effected by the physics speed
	 * @return AudioSource A reference to this AudioSource
	 */
